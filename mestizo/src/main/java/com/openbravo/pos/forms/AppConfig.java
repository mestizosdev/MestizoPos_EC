...
public class AppConfig implements AppProperties {
  ...
  private void loadDefault() {
    ...
    m_propsconfig.setProperty("db.driverlib", new File(new File(dirname)
            , "mysql-connector-java-8.0.29.jar").getAbsolutePath());
...
// primary DB
    ...
    m_propsconfig.setProperty("db.schema", "mestizo");
...
// secondary DB        
    ...
    m_propsconfig.setProperty("db1.schema", "mestizo");
    ...
    m_propsconfig.setProperty("tkt.header3", "Copyright © 2009-2020 uniCenta");
